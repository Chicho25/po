...
<?php   include("include/config.php");
        ...
        $registros_country = Getrecords("SELECT * FROM country WHERE id = '".$_GET['id']."'");
        ?>
  ...
  <div class="modal-content">
  	<form role="form" class="form-horizontal" id="role-form"  method="post" action="" enctype="multipart/form-data">
	      ...
	      <div class="row">
		      <div class="form form-horizontal">
			    <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" class="form-control" name="country" value="<?php echo $registros_country[0]['name']; ?>" placeholder="Pais">
                        <input type="hidden" class="form-control" name="id_country" value="<?php echo $registros_country[0]['id']; ?>">
                    </div>
                </div>
			</div>
		</div>
	    ...
	    <div class="modal-footer">
	      ...
	      <button type="submit" name="submitEditCountry" class="btn btn-primary">Ok</button>
	    </div>
    </form>
  </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->